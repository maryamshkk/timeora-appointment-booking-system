...
const mockAppointmentData = {
    appointmentId: "APT-20260821-1042",
    customer: "Hina Malik",
...
function StaffRescheduleAppointment() {
    ...
    const originalDate = new Date(2026, 7, 21);
    ...
    function generateHourlySlots(startHour, endHour, unavailableSlots = []) {
        ...
        for (let hour = startHour; hour < endHour; hour++) {
            const start = new Date(2026, 7, 21, hour, 0);
            const end = new Date(2026, 7, 21, hour + 1, 0);
    ...
    function formatSlotTime(slotValue) {
        ...
        const start = new Date(2026, 7, 21, hourNumber, 0);
        const end = new Date(2026, 7, 21, hourNumber + 1, 0);
    ...
    function handleConfirm() {
        ...
        // TODO: axios PATCH /api/staff/appointments/:id/reschedule
        // const newDate = formatDateKey(selectedDate);
        // const newSlot = selectedSlot;
        // await api.patch(`/staff/appointments/${appointmentId}/reschedule`, {
        //     newDate,
        //     newSlot,
        // });
                        ...
                        <div className="space-y-5 lg:col-span-2">
                            ...
                            <div className="rounded-xl border border-gray/20 bg-white p-5 shadow-sm sm:p-6">
                                ...
                                <div className="mb-6 flex items-center justify-between">
                                    ...
                                    <div>
                                        ...
                                        <h2 className="mt-1 font-serif text-lg text-navy sm:text-xl">
                                            Appointment Details
                                        </h2>
                                    </div>
                            ...
                            <div className="rounded-xl border border-gray/20 bg-white p-5 shadow-sm sm:p-6">
                                ...
                                <div className="flex items-center justify-between border-b border-gray/20 pb-5">
                                    ...
                                    <p className="font-serif text-base font-bold uppercase tracking-wide text-navy sm:text-lg">
                                ...
                                <div className="mt-6 border-t border-gray/20 pt-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                                        ...
                                        {generateHourlySlots(9, 17, ["10:00"]).map(
                                            (slot) => {
                                                const isSelected =
                            ...
                            <div className="rounded-xl border border-gray/20 bg-white p-5 shadow-sm sm:p-6">
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <button
                                        ...
                                        className="
                                            w-full rounded-lg bg-navy px-4 py-3
                                            text-sm font-bold text-white transition
                                            hover:bg-gold hover:text-navy
                                            disabled:cursor-not-allowed
                                            disabled:bg-gray/30 disabled:text-slate
                                        "
                                    >
                                        Confirm Reschedule
                                    </button>
                                    ...
                                    <button
                                        ...
                                        className="
                                            w-full rounded-lg border border-gray/30
                                            px-4 py-3 text-sm font-bold text-slate
...
export default StaffRescheduleAppointment;