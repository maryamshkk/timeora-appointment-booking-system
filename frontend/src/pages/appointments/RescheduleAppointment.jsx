...
function RescheduleAppointment() {
    ...
    function handleSubmit(event) {
        ...
        // payload: { date: formatDateKey(selectedDate), time: selectedSlot }
                ...
                <main className="flex-1 bg-beige px-3 py-4 sm:px-4 sm:py-5 md:px-6 lg:px-8 lg:py-6">
                    ...
                    <div className="mx-auto w-full max-w-[640px] space-y-5">
                        ...
                        <form
                            ...
                            className="rounded-xl border border-gray/20 bg-white p-6 shadow-sm"
                        >
                            {/* Actions */}
                            <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                                <button
                                    type="button"
                                    onClick={() => navigate(-1)}
                                    className="flex items-center justify-center gap-2 rounded-lg border border-gray/40 px-5 py-2.5 text-sm font-bold text-slate transition hover:border-navy hover:text-navy"
                                >
                                    <X className="h-4 w-4" />
                                    Cancel
                                </button>
                                ...
                                <button
                                    ...
                                    className="flex items-center justify-center gap-2 rounded-lg bg-navy px-5 py-2.5 text-sm font-bold text-white transition hover:bg-gold hover:text-navy disabled:cursor-not-allowed disabled:opacity-40"
                                >
